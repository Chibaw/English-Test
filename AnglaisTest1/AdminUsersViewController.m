...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [self.userLastNames count];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    AdminUsersCell *cell = [tableView dequeueReusableCellWithIdentifier:@"userAdminCell"];
    
    cell.userFirstName.text = [self.userFirstNames objectAtIndex: [indexPath row]];
    cell.userLastName.text = [self.userLastNames objectAtIndex: [indexPath row]];
    cell.userMail.text = [self.userMails objectAtIndex: [indexPath row]];
    return cell;
}
